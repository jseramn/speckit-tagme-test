...
import { updateShift } from "@/lib/supervisor/org/shifts";
import { supervisorOrgErrorResponse } from "@/lib/supervisor/org-errors";
import { shiftUpdateSchema } from "@/lib/validators/supervisor-org";
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const item = await updateShift(session, id, parsed.data);
